...
(f_x-f_z2xe^{x^2+y^2}) \delta x + (f_y-f_z2ye^{x^2+y^2} )\delta y=0
\end{align*}
Which must hold for any value of $\delta x$ and $\delta y$, thus
\begin{align*}
f_x-f_z2xe^{x^2+y^2}=0 \\
f_y-f_z2ye^{x^2+y^2}=0 \\
\vec{f}(x,y)=(2xe^{x^2+y^2},2ye^{x^2+y^2},1)f_z
\end{align*}
I am not sure how to proceed from here. Any comments on this would be greatly appreciated. 
