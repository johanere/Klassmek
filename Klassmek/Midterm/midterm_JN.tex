...
\item $H=\sum_i p_i \dot{q_i}-L= p_{\phi} \dot{\phi} + p_r\dot{r}-(\frac{1}{2}\mu (\dot{r}^2+r^2\dot{\phi}^2)+V(r))=\sum_i p_i \dot{q_i}-L= p_{\phi} \dot{\phi} + p_r\dot{r}-\frac{1}{2}\frac{p_r \dot{r}}{\mu}-\frac{1}{2}\frac{p_\phi }{\mu}  +V(r))$
